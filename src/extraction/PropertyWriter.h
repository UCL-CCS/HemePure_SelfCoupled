	...
	namespace extraction
	{
		class PropertyWriter
		{
			public:
				 ...
				 * @return
				 */
				PropertyWriter(IterableDataSource& dataSource, const std::vector<PropertyOutputFile*>& propertyOutputs, const net::IOCommunicator& ioComms, const MPI_Comm& unComms);
				...
				/**
				 * Returns true if coupling this step.
				 * @return
				 */
				 ...
				 * @return
				 */
				std::unordered_map<int, std::vector<int> > GetIoletMap() const;
