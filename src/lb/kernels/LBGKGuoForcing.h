		...
		namespace kernels
		{
			...
			template<class LatticeType>
				struct HydroVars<LBGKGuoForcing<LatticeType> > : HydroVarsBase<LatticeType>
				{
					...
					//const LatticeForceVector& force; //JM
					LatticeForceVector force;
					...
					//HydroVars(const distribn_t* const f, const LatticeForceVector& _force) :  //JM
					HydroVars(const distribn_t* const f, LatticeForceVector& _force) :
