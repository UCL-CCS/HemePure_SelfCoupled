...
//            }
      ...
      LatticeForceVector BoundaryValues::GetBoundaryForce(const int iBoundaryId)
      {
	//printf("hitting boundaryvalues.cc on %i \n", iBoundaryId);
        return iolets[iBoundaryId]->GetForce();
      }
      
      //PhysicalSpeed BoundaryValues::GetSpeedMax(int iBoundaryId)
      //{
      //  return iolets[iBoundaryId]->GetSpeedMax();
      //}
